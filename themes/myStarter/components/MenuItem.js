      ...
      {!hasSubMenu && (
        <li className='group relative whitespace-nowrap'>
          <SmartLink
            href={link?.href}
            target={link?.target}
            className={`ud-menu-scroll flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:inline-flex lg:py-0 lg:text-gray-800 lg:group-hover:text-primary lg:group-hover:opacity-70`}>
      ...
      {hasSubMenu && (
        <li className='submenu-item group relative whitespace-nowrap'>
          <button
            ...
            className={`cursor-pointer relative flex items-center justify-between py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:inline-flex lg:py-0 lg:text-gray-800 lg:group-hover:text-primary lg:group-hover:opacity-70`}>
            <span>
              {link?.icon && <i className={link.icon + ' mr-2 my-auto'} />}
              {link?.name}
            </span>
